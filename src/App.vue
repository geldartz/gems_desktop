...
<template>
  <div class="grid grid-cols-4">
      <div class="w-full border border-gray-400 px-5 h-screen shadow-lg bg-white z-[101]">
          <div class="my-5">
      ...
      <div class="col-span-3 h-screen bg-slate-50 overflow-y-auto overflow-x-hidden">
          <router-view>

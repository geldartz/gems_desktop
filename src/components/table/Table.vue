<template>
    <div>
        <div v-if="hasUpperFilers" class="w-full flex my-4 py-2 justify-between items-center">
            <div class="flex-initial w-full">
                <div class="flex items-center">
                    <div :class="[searchLg ? 'w-full' : 'w-2/3']" class="mr-3" v-show="showSearch">
...
import { errorMessage } from "@/utils/toast.js";
